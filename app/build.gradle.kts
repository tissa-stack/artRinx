...
// Release signing credentials are kept out of the repo in keystore.properties (gitignored).
// Guarded by existence so machines/CI without the file can still build debug without failing.
